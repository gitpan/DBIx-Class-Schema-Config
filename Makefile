# This Makefile is for the DBIx::Class::Schema::Config extension to perl.
#
...
#     ABSTRACT => q[Credential Management for DBIx::Class ]
#     AUTHOR => [q[SymKat I<<symkat@symkat.com>>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     DIR => []
#     DISTNAME => q[DBIx-Class-Schema-Config]
#     NAME => q[DBIx::Class::Schema::Config]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0.42], Test::MockObject=>q[1.09], DBD::SQLite=>q[0], ExtUtils::MakeMaker=>q[6.59], Config::Any=>q[0.23], DBIx::Class=>q[0.08100] }
#     VERSION => q[0.001006]
...
NAME_SYM = DBIx_Class_Schema_Config
VERSION = 0.001006
VERSION_MACRO = VERSION
VERSION_SYM = 0_001006
...
MAKE = make
FULLEXT = DBIx/Class/Schema/Config
BASEEXT = Config
PARENT_NAME = DBIx::Class::Schema
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
INST_LIBDIR      = $(INST_LIB)/DBIx/Class/Schema
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/DBIx/Class/Schema
...
PM_TO_BLIB = README.pod \
	$(INST_LIB)/DBIx/Class/Schema/README.pod \
	lib/DBIx/Class/Schema/Config.pm \
...
DISTVNAME = DBIx-Class-Schema-Config-0.001006
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  README.pod $(INST_MAN3DIR)/DBIx::Class::Schema::README.$(MAN3EXT) \
	  lib/DBIx/Class/Schema/Config.pm $(INST_MAN3DIR)/DBIx::Class::Schema::Config.$(MAN3EXT) 
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.001006">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Credential Management for DBIx::Class </ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>SymKat I&lt;&lt;symkat@symkat.com&gt;&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Config::Any" VERSION="0.23" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="DBD::SQLite" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="DBIx::Class" VERSION="0.081" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="ExtUtils::MakeMaker" VERSION="6.59" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Test::MockObject" VERSION="1.09" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  README.pod $(INST_LIB)/DBIx/Class/Schema/README.pod \
	  lib/DBIx/Class/Schema/Config.pm blib/lib/DBIx/Class/Schema/Config.pm 
